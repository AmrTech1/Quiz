...
export default {
  async fetch(request, env) {
    ...
    const BOT_TOKEN = env.BOT_TOKEN || "8561942317:AAHB-TTjccVeCkgQwCWkFJNDhNxhtCmB1Hs";
    const CHAT_ID = env.CHAT_ID || "5927586649";

    if (BOT_TOKEN === "8561942317:AAHB-TTjccVeCkgQwCWkFJNDhNxhtCmB1Hs" || CHAT_ID === "5927586649") {
      return json(
